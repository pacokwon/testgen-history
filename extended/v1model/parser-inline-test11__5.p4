...
// - one invocation of each instance with the same arguments
...
parser ParserImpl(      packet_in           packet,
    ...
    state p0 { subp1.apply(packet, hdr, phdr); transition p2; }
    state p1 { subp2.apply(packet, hdr, phdr); transition p2; }
